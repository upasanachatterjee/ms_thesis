...
Given the inconsistent pattern of gains and the specific risk of degrading Center and Right performance, we opt not to use undersampling in our main experiments.
