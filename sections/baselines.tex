...
\bottomrule
\end{tabular}
\caption{Baseline system performance on AllSides political bias classification. Human performance represents average scores across four annotators on a subset. Transformer systems are evaluated on both data splits to quantify source leakage effects. LLM systems are evaluated only on Media Split due to zero-shot configuration.}
