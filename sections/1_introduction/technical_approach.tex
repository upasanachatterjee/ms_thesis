...
We also extend the AllSides dataset \citep{baly2020we}, which provides article-level political bias annotations for U.S. news content, by incorporating additional annotated articles.
