...
\begin{enumerate}
    ...
    \item \textbf{Causal Analysis of Theme-Tone-Ideology Relationships}: What are the causal effects of specific thematic and tonal features on political ideology classification at both the topic and community levels, and how do automated systems---including fine-tuned classifiers and LLMs in both zero-shot and fine-tuned configurations---differ from human expert annotators in the causal structure of their predictions?
\end{enumerate}
