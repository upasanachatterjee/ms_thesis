...
The rest of this chapter presents a causal inference framework applied to the AllSides dataset. We formalize the causal structure using a directed graph, describe our Double Machine Learning (DML) methodology, and report results at two levels of analysis---topic-level and community-level---across five annotation paradigms: human labels, a fine-tuned RoBERTa classifier, zero-shot GPT-4o-mini, fine-tuned GPT-4o-mini, and zero-shot Llama-3.3-70B. At the topic level, no robust causal effects emerge: human and Fine-tuned RoBERTa annotations produce no significant effects (apart from an isolated, non-replicating Hillary Clinton signal under RoBERTa), significance is paradigm-dependent, and estimated causal directions can reverse depending on the annotation model used. At the community level, only the fine-tuned GPT-4o-mini produces significant effects---for Social Issues, Geopolitics, and Trump Presidency communities---while human, Fine-tuned RoBERTa, and Llama-3.3-70B annotations remain null. Llama-3.3-70B exhibits a distinct failure mode: rather than producing sign reversals like GPT models, it systematically attenuates all effect sizes toward zero. We interpret the fine-tuned GPT divergence as evidence of shortcut learning: fine-tuning introduces spurious sentiment-ideology coupling that is invisible to standard F1-based evaluation but surfaces under causal probing.
