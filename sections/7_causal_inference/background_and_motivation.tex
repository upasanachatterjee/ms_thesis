...
The rest of this chapter presents a causal inference framework applied to the AllSides dataset. We formalize the causal structure using a directed graph, describe our Double Machine Learning (DML) methodology, and report results across three annotation paradigms: human labels, our best performing additionally pre-trained and fine-tuned RoBERTa classifier, and our best performing fine-tuned LLM model. %A key finding is that topic-level sentiment is a weak driver of ideology classification once topic presence is controlled for---and that estimated causal directions can reverse depending on the annotation model used.
