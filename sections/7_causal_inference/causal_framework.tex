...
\begin{table}[h]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \end{tabular}
    \end{minipage}
    \caption{Top five communities and topic tags in the AllSidesV2 media split test set. Total article count is 9,830. The full community structure with all 14 communities and their constituent topics is provided in Appendix~\ref{appendix:community-structure}.}
