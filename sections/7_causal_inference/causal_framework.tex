...
\begin{figure}[h]
    ...
    % \end{tikzpicture}
    \includegraphics[width=0.6\textwidth]{sections/images/causal_diagram.png}
    \caption{Complete causal diagram for article ideology classification. Note, we do not include article text in our investigations.}
...
\begin{figure}[h!]
  ...
  \end{tikzpicture}
  \caption{Expanded setup: sentiment variables as mediators. Blue arrows show treatment-to-mediator paths; red shows mediator-to-outcome paths.}
  \label{fig:causal3}
\end{figure}
