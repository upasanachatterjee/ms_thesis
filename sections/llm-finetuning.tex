...
\bottomrule
\end{tabular}
\caption{GPT-4o-mini fine-tuning performance across different training configurations. Results show F1 scores for the AllSides Media Split evaluation set. Full text experiments demonstrate higher performance ceiling but require substantial training data, while 400-word truncation provides more consistent improvements with limited supervision.}
