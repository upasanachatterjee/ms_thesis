...
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{System} & \textbf{F1-Macro} & \textbf{Left} & \textbf{Center} & \textbf{Right}\\
 \midrule
...
\bottomrule
\end{tabular}
\caption{Baseline system performance on extended AllSides dataset (Media Split). All systems show improved performance compared to original dataset results, with particularly notable gains for center-category classification.}
...
% TODO: - Detailed temporal analysis of political bias evolution across the extended time periods
% TODO: - Analysis of article length distribution and its impact on classification performance
% TODO: - Error analysis identifying specific types of articles that remain challenging after dataset extension
